...
<div className="h-auto ml-4 ">
          <div className="flex flex-col sm:flex-row  ">
            <div className="w-[100%] sm:w-[50%]  " id="bigimg">
              <img
                src={img2}
            ...
            <div className="flex justify-center mr-7 mb-0 md:pb-0 sm:pb-40 w-[50%]  border-l-2 border-l-zinc-900 " id="border">
              <div className="flex flex-col gap-3 bg-white w-[30%] justify-center items-center py-3">
                ...
                <div className="flex flex-row bg-[#e0e1dd] w-[400px] h-[100px] rounded-md" id="car">
                  <div className="bg-[#FF9F1C] h-[100px] w-[80px] flex justify-center items-center rounded-md" id="image">
        ...
        <div className="h-[85vh] ml-4 ">
          <div className="flex flex-col-reverse sm:flex-row">
            ...
            <div className="flex flex-col gap-3 bg-white w-[50%] justify-center items-center py-3  ">
...
<div className="h-auto ml-4 ">
          <div className="flex flex-col sm:flex-row  ">
            <div className="w-[100%] sm:w-[60%]  " id="bigimg">
              <img
                src={img2}
                className="w-[100%] object-contain    h-[200px] sm:h-[80vh]  sm:ml-0 ml-8 "
                alt=""
            ...
            <div className="flex justify-center mr-7 mb-0 md:pb-0 sm:pb-40 w-[40%]  border-l-2 border-l-zinc-900 " id="border">
              <div className="flex flex-col gap-3 bg-white w-[30%] justify-center items-center py-3">
