          ...
          <Paper elevation={3} sx={{ padding: "2rem" }}>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                This website is operated by Am Robotics. Throughout the site,
                the terms “we”, “us” and “our” refer to Am Robotics. Am Robotics
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                will result in an immediate termination of your Services and
                action against you.
              </Typography>
            </section>
            <section style={{ marginBottom: "2rem" }}>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                shall Am Robotics, our directors, officers, employees,
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                You agree to indemnify, defend and hold harmless Am Robotics and
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                accordance with the laws of Am Robotics.
              </Typography>
            </section>
            <section style={{ marginBottom: "2rem" }}>
              <Typography variant="h6" gutterBottom>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <Typography variant="body1" gutterBottom>
                Questions about the Terms of Service should be contacting Am
                Robotics.
              </Typography>
            </section>
          </Paper>
